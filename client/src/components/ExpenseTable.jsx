      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full">
          <thead style={{ borderBottom: '1px solid var(--border)' }}>
            <tr>
              <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" style={{ color: 'var(--text-muted)', fontSize: '11px', letterSpacing: '0.8px' }}>
                Date
              </th>
              <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" style={{ color: 'var(--text-muted)', fontSize: '11px', letterSpacing: '0.8px' }}>
                Category
              ...
              <th className="px-4 sm:px-6 py-3 text-right text-xs font-medium uppercase tracking-wider" style={{ color: 'var(--text-muted)', fontSize: '11px', letterSpacing: '0.8px' }}>
                Amount
              </th>
              <th className="px-4 sm:px-6 py-3 text-right text-xs font-medium uppercase tracking-wider" style={{ color: 'var(--text-muted)', fontSize: '11px', letterSpacing: '0.8px' }}>
                Actions
          ...
          <tbody className="divide-y" style={{ borderColor: '#f1f5f9' }}>
            {expenses.map((expense) => (
              <tr key={expense.id} style={{ transition: 'background-color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#f8fafc'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm" style={{ color: 'var(--text-secondary)' }}>
          ...
          >
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <span className="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded" style={getBadgeStyle(expense.category)}>
                  {expense.category}
                </span>
              </div>
